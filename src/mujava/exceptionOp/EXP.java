...
public class EXP extends mujava.op.util.Mutator
{
  public EXP(FileEnvironment file_env,ClassDeclaration cdecl,
	...
	throws ParseTreeException
    {
      ...
      if((!catch_list.isEmpty())&&(!finstmts.isEmpty())){
        //
    	  ...
    	  System.out.println(catch_list);
    	  System.out.println(finstmts);
    	  outputToFile(p);
      }
    }
