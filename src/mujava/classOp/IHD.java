...
public class IHD extends DeclAnalyzer {
	 ...
	 * <i> When to generate</i>: if declared fields have the same name and type
	 * with the inherited fields
	 */
	public void translateDefinition(CompilationUnit comp_unit)
		...
		for (int i = 0; i < d_fields.length; i++) {
			// private fields do not have have no effect although they are
			// hidden.
	...
	public void outputToFile(CompilationUnit comp_unit,
			FieldDeclaration original, FieldDeclaration mutant) {
	...
	public IHD(openjava.mop.Environment oj_param0,
