...
public class OMD extends DeclAnalyzer
{
   ...
   private boolean omdPossible(OJMethod m1, OJMethod m2)
   {
	  ...
	  if ( m1.getParameterTypes().length == 0 ) 
		 return false;
	  System.out.println(">>>>>>>>omd3>>>>>>......omdPossible"+m1.getParameterTypes()+">>>>"+m2.getParameterTypes());
	  if ( m1.getParameterTypes().length != m2.getParameterTypes().length ) 
		 return false;
	  System.out.println(">>>>>>>>omd4>>>>>>......omdPossible"+m1.getParameterTypes()+"<<<<<<"+m2.getParameterTypes());
      ...
      {
    	  System.out.println(">>>>>>>>omd5>>>>>>......omdPossible");
    	  return true;
      }
	  return false;
   }
