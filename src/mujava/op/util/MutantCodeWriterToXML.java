...
public class MutantCodeWriterToXML extends ParseTreeVisitor
{
   ...
   public MutantCodeWriterToXML( PrintWriter out ) 
   {
      super();
      this.out = out;
   }

   public MutantCodeWriterToXML( String mutant_dir, PrintWriter out ) 
   {
      super();
      this.out = out;
   ...
   protected final boolean isSameObject (ParseTree p, ParseTree q ) {
	 ...
	 throws ParseTreeException
    {
    	...
    	out.print("<ClassDeclaration name=\""+p.getName()+"\"");
    ...
    //	out.print("*********"+p.getName()+"****************\n");
     //   writeTab();
        ...
        if(p.isEnumeration()){
	        ...
	        if (p.isInterface()) {
	            out.print( " type=\"interface\" " );
	        } else {
	            out.print( " type=\"class\" " );
	        }
...
//			out.print(name);
	...
	throws ParseTreeException
    {
    	out.print( "<AllocationExpression " );
	...
	throws ParseTreeException
    {
    	out.print("<AssignmentExpression");
        Expression lexpr = p.getLeft();
        out.print(" LEFTExpression=\"");
	...
	throws ParseTreeException
    {
        out.print(" modifier=\""+ ModifierList.toString( p.getRegular() )+"\"" );
    }
    ...
    {
      CodeChangeLog.writeLog(class_name+logIdentifier +mutated_line);
    }

    protected void writeLog(String changed_content)
    {
      CodeChangeLog.writeLog(class_name+logIdentifier
	  +mutated_line+logIdentifier+changed_content);
    }
