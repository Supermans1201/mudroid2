...
public class Mutator extends mujava.openjava.extension.VariableBinder
{
   ...
   public Mutator( Environment env, CompilationUnit comp_unit,String Path,String Name) 
   {
      super( env );
      this.comp_unit = comp_unit;
      mutantPath=Path;
   ...
   protected OJClass getType( Expression p ) throws ParseTreeException 
   {
      ...
      try 
      {
	   ...
	   //  System.err.println(p.getClass() + " : " + p.getClass());
      } catch ( Exception e ) {	  
//    	  System.err.println("mutator:p: " + p);
//    	  System.err.println("getEnvironment() : " + env);
//     	 System.err.println("getEnvironment() : " + getEnvironment().toString());
   	
		System.err.println("Exception: " + e.toString()+" "+p.getClass()+" "+p.toString());
...
//	     System.out.println("getSelfType");
...
//      System.out.println(cc.getName()+"   "+cc.getPackage().getName());
//      System.out.println("getClassName");
//      System.out.println(exclude(cc.getName(),cc.getPackage().getName()));
