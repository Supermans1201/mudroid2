...
{
    public int num = 0;
    protected static String mutantPath=null;
    ...
    public String getSourceName(OJClass clazz){
      ...
      //name = AndroidMutationSystem.getPrefix()+getClassName()+"_"+this.num+".java";
      return name;
    }
    ...
    public DeclAnalyzer( openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1, ClassDeclaration oj_param2 ,String path,String name)
    {
        super( oj_param0, oj_param1, oj_param2 );
        mutantPath=path;
        className=name;
