...
public class MDL extends DeclAnalyzer
{
   ...
   public void outputToFile(CompilationUnit comp_unit, MethodDeclaration target)
   {
      ...
      try 
      {
         ...
         MDL_Writer writer = new MDL_Writer( mutant_dir, out );
   ...
   public MDL( openjava.mop.Environment oj_param0, openjava.mop.OJClass oj_param1, openjava.ptree.ClassDeclaration oj_param2 )
   {
      super( oj_param0, oj_param1, oj_param2 );
   }

   @SuppressWarnings("rawtypes")
public MDL( java.lang.Class oj_param0, openjava.mop.MetaInfo oj_param1 )
   {
