...
public class ETR extends mujava.op.util.PolymorphicMutator
{
   ...
   public ETR(FileEnvironment file_env, ClassDeclaration cdecl, CompilationUnit comp_unit)
   {
	...
	// TODO Auto-generated method stub
	   if (comp_unit == null) 
	      ...
	      try 
	      {
			 ...
			 ETR_Writer writer = new ETR_Writer( mutant_dir, out );
